...
if (empty($_GET['key'])	|| $apiKey !== $_GET['key']) {
...
// The Crowdin Normal address and JSON Structure
$url = 'https://crowdin.com/api/v2/projects/' . $event['project_id'] . '/translations/builds';
$parameter = [
