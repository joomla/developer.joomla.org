...
<div class="contact<?php echo $this->pageclass_sfx?>" itemscope itemtype="https://schema.org/Person">
	...
	<?php if ($this->contact->id == 1) : ?>
		<div class="alert alert-info">
			<p>To report a security issue in the core Joomla! CMS or Framework, or with a joomla.org website, please submit the below form containing as much detail as possible about the issue. Additional information about our security team and their processes may be found on our <a href="https://developer.joomla.org/security.html" class="alert-link">Security page</a>.</p>
			<p>To report an issue in a Joomla! extension, please submit it to the <a href="https://vel.joomla.org/submit-vel" class="alert-link">Vulnerable Extensions List</a>.</p>
			<p>For support with a site which has been attacked, please visit the <a href="https://forum.joomla.org/viewforum.php?f=714" class="alert-link">Joomla! Forum</a>.</p>
		</div>
	<?php endif; ?>
	...
	<?php if ($this->contact->image && $tparams->get('show_image')) : ?>
		<div class="thumbnail pull-right">
			<?php echo HTMLHelper::_('image', $this->contact->image, $this->contact->name, array('align' => 'middle', 'itemprop' => 'image')); ?>
		</div>
	<?php endif; ?>
