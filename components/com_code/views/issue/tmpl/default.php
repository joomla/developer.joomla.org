...
<div class="issue<?php echo $this->pageclass_sfx?>">
	...
	<div id="issue-content">
		<h4><?php echo Text::_('COM_CODE_ISSUE_SUMMARY'); ?></h4>
		<div class="row-fluid">
			<div class="span9">
			...
			<div class="span3 well">
				<h5><?php echo Text::_('COM_CODE_ISSUE_OPENED_ON'); ?></h5>
				<div><?php echo Text::sprintf('COM_CODE_ISSUE_OPENED_ON_INFO', HTMLHelper::_('date', $this->item->created_date, 'j M Y, G:i'), $this->item->created_by_name); ?></div>
				<?php if ($this->item->state == '0') : ?>
					<h5><?php echo Text::_('COM_CODE_ISSUE_CLOSED_ON'); ?></h5>
					<div><?php echo HTMLHelper::_('date', $this->item->close_date, 'j M Y, G:i'); ?></div>
				<?php endif; ?>
				<h5><?php echo Text::_('COM_CODE_ISSUE_STATUS'); ?></h5>
