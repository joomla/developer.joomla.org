...
<div class="clearfix">
	<div id="tracker-filters" class="form-inline well">
			...
			<div class="span6">
				<div class="control-group">
					...
					<div class="controls">
						...
						<?php echo HTMLHelper::_('calendar', $model->getState('issue.start_date_range'), 'filter_start_date_range', 'filter_start_date_range', '%Y-%m-%d', ['class' => 'input-small']); ?>
						<?php echo HTMLHelper::_('calendar', $model->getState('issue.end_date_range'), 'filter_end_date_range', 'filter_end_date_range', '%Y-%m-%d', ['class' => 'input-small']); ?>
        ...
        <i class="icon-plus"></i> <?php echo Text::_('COM_CODE_TRACKER_FILTER_ADVANCED_SEARCH'); ?></button>
