...
/**
 * Repositories management model class.
 */
class GHMarkdownDisplayModelRepositories extends ListModel
{
	/**
	 * Constructor.
	 *
	...
	public function __construct($config = [])
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = [
				'id', 'a.id',
				'name', 'a.name',
				'repository_owner', 'a.repository_owner',
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__ghmarkdowndisplay_repositories', 'a'));
