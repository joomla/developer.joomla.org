...
/** @var GHMarkdownDisplayViewDocuments $this */
...
if ($saveOrder)
{
	HTMLHelper::_('sortablelist.sortable', 'documentList', 'adminForm', strtolower($listDirn), 'index.php?option=com_ghmarkdowndisplay&task=documents.saveOrderAjax&tmpl=component');
}
?>
<form action="<?php echo Route::_('index.php?option=com_ghmarkdowndisplay&view=documents'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="col-md-10">
		...
		<?php if (empty($this->items)) : ?>
			<div class="alert alert-no-items">
				<?php echo Text::_('COM_GHMARKDOWNDISPLAY_MSG_NO_DOCUMENTS_MATCHING_QUERY'); ?>
			</div>
		<?php else : ?>
				...
				<thead>
					<tr>
						...
						<th width="20%" class="nowrap">
							<?php echo HTMLHelper::_('searchtools.sort', 'COM_GHMARKDOWNDISPLAY_HEADING_SECTION', 's.name', $listDirn, $listOrder); ?>
						</th>
						<th width="20%" class="nowrap">
				...
				<tbody>
					<?php foreach ($this->items as $i => $item) : ?>
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td class="text-center">
								<div class="btn-group">
									<?php echo HTMLHelper::_('jgrid.published', $item->published, $i, 'documents.'); ?>

									<?php HTMLHelper::_('actionsdropdown.' . ((int) $item->published === -2 ? 'un' : '') . 'trash', 'cb' . $i, 'documents'); ?>
							...
							<td class="has-context">
								<div class="float-start break-word">
									...
									<?php endif; ?>
									<a href="<?php echo Route::_('index.php?option=com_ghmarkdowndisplay&task=document.edit&id=' . (int) $item->id); ?>">
